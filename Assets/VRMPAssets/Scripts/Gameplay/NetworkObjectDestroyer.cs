...
namespace XRMultiplayer
{
    ...
    public class NetworkObjectDestroyer : NetworkBehaviour
    {
        ...
        void Triggered(Collider other, bool entered)
        {
            ...
            {
                if (m_UndestroyableInteractables.Contains(networkBaseInteractable) || networkBaseInteractable.isInteracting || networkBaseInteractable.NetworkObject.InScenePlaced) return;
