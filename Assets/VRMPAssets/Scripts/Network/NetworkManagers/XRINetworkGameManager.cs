...
# endif
        ...
        static void ResetStatics()
        {
            s_Instance = null;
            LocalId = 0;
            AuthenicationId = null;
            ConnectedRoomCode = null;
            ConnectedRoomRegion = null;
            ConnectedRoomName = new BindableVariable<string>("");
            LocalPlayerName = new BindableVariable<string>("Player");
            LocalPlayerColor = new BindableVariable<Color>(Color.white);
            m_Connected = new BindableVariable<bool>(false);
