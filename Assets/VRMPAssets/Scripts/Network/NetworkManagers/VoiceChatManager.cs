...
namespace XRMultiplayer
{
    ...
    public class VoiceChatManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            // LocalOnly sessions disable this component via SessionManager.Start → SetupLocalTransport.
        ...
        public void ToggleSelfMute(bool setManual = false, bool mutedOverrideValue = false)
        {
            ...
            if (XRINetworkGameManager.CurrentSessionType == SessionType.DistributedAuthority && VivoxService.Instance != null && VivoxService.Instance.IsLoggedIn)
            {
        ...
        {
            // LocalPlayer is cleared in OnNetworkDespawn, which can run before Vivox finishes
            // firing its participant-removed callbacks on disconnect. Guard before accessing it.
